...
function RuleCard({ rule, onOpen }: { rule: Rule; onOpen: ()=>void }) {
  return (
    <article className="group relative overflow-hidden rounded-3xl border border-[color:var(--glass-border)] bg-[color:var(--glass)] p-5 shadow-xl backdrop-blur-2xl transition hover:scale-[1.01] hover:shadow-2xl">
